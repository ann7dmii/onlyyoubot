...
def menu(message):
    ...
    elif message.text == "🎲 случайное воспоминание":
        memories = [
            "🤍 первая прогулка\n\n"
            "тот самый день, когда у меня так сильно потели руки от волнения, "
            "а я с максимально невинным лицом утверждала, "
            "что это всё потому, что я просто намазала их кремом 😭🤍",

            "💋 наш первый поцелуй\n\n"
            "тот самый момент у Лёши на хате, "
            "который я, кажется, никогда не забуду 🥹❤️",

            "🌧️ прогулка под дождём\n\n"
            "когда начался дождь, а ты ещё умудрялся отказываться "
            "от моих 50 рублей на проезд 😭\n\n"
            "я ведь просто хотела, чтобы ты не промок и нормально доехал ❤️",

            "🐶 «я хотел сказать, что ты собака»\n\n"
            "я до сих пор помню этот момент и, если честно, "
            "вряд ли когда-нибудь его забуду 😂\n\n"
            "почему-то именно эта фраза намертво засела у меня в голове 😭",

            "📺 старая квартира + ОСД\n\n"
            "когда ты пришёл ко мне ещё в мою прошлую квартиру, "
            "и мы просто сидели вместе и смотрели «Очень странные дела» 🥹🤍\n\n"
            "вроде ничего особенного, но почему-то именно такие "
            "спокойные моменты я люблю больше всего."
        ]
